...
p. If you need all messages to be approved, then you'll have to connect connect the projector to a comp and split the screen so that the approval window isn't displayed on the big screen :)
